...
export const sourcePacketRegressionCases: SourcePacketRegressionCase[] = [
  ...
  },
  {
    ...
    forbidden: [
      ...
      { label: 'medication order invented', pattern: /(?:continue|continued|restart|restarted) (?:Depakote|lithium|valproate|depokte)|(?:Depakote|lithium|valproate) (?:continued|restarted)/i },
  ...
  },
  {
    ...
    required: [
      ...
      { label: 'diagnosis remains broad or unfinalized', pattern: /working assessment|not verified|not confirmed|no final diagnosis|deferred/i },
    ],
    forbidden: [
