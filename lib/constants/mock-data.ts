...
export const templateOptionsByNoteType: Record<string, string[]> = {
  ...
  'Psychiatric H&P': ['Default Psychiatric H&P', 'Psych H&P - Medical Confounders'],
  ...
  'Therapy Intake': ['Default Therapy Intake', 'Therapy Intake - Biopsychosocial'],
...
export const templateDescriptions: Record<string, string> = {
  ...
  'Default Psychiatric H&P': 'Psychiatric history and physical profile that keeps medical confounders and source limits visible.',
  'Psych H&P - Medical Confounders': 'H&P framing for psychiatric presentations with unclear EKG, labs, med history, or medical contributors.',
  ...
  'Default Therapy Intake': 'Therapy intake structure for referral reason, client report, collateral, safety, and initial planning.',
  'Therapy Intake - Biopsychosocial': 'Therapy intake profile with more room for biopsychosocial context, source conflicts, and treatment-planning needs.',
