...
const DOSE_OVERRIDES: Record<string, MedicationOverride> = {
  ...
  lamotrigine: {
    typicalAdultStartingDose: '25 mg/day',
    typicalAdultRange: '100-200 mg/day for many bipolar maintenance regimens',
    maxDoseNotes: 'Titration changes substantially with valproate or enzyme inducers.',
    availableStrengths: ['25 mg', '100 mg', '150 mg', '200 mg'],
    dosageForms: ['tablet', 'chewable/dispersible tablet', 'orally disintegrating tablet', 'extended-release tablet'],
  },
  ...
  quetiapine: {
    typicalAdultStartingDose: '25-50 mg at bedtime or divided',
    typicalAdultRange: '50-800 mg/day depending on indication',
    availableStrengths: ['25 mg', '50 mg', '100 mg', '200 mg', '300 mg', '400 mg'],
