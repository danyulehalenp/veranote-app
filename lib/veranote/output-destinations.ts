...
const OUTPUT_DESTINATION_META: Record<OutputDestination, OutputDestinationMeta> = {
  ...
  Luminello: {
    label: 'Luminello',
    behavior: 'psych-ehr-safe',
    summaryLabel: 'Luminello-ready',
    pasteExpectation: 'Use concise psychiatry-forward sections that can be copied into visit notes without relying on rich text behavior.',
    fieldGuideSummary: 'Suggested paste targets for outpatient psychiatry notes, med-management follow-ups, and therapy-adjacent sections.',
    preserveHeadings: true,
    enforceAsciiSafe: false,
    preferParagraphOnly: true,
    normalizeSpacing: true,
    ...
    fieldTargets: [
      {
        id: 'luminello-interval-history',
        label: 'Interval history / HPI',
        aliases: ['chief complaint', 'chief concern', 'hpi', 'subjective', 'interval update', 'symptom review'],
        note: 'Use for patient-reported symptoms, interval course, and visit narrative.',
      },
      {
        id: 'luminello-mse-risk',
        label: 'MSE / risk',
        aliases: ['mental status', 'observations', 'risk assessment', 'safety', 'insight', 'judgment'],
        note: 'Use for source-supported mental status observations and risk language.',
      },
      {
        id: 'luminello-assessment',
        label: 'Assessment',
        aliases: ['assessment', 'diagnosis', 'clinical status', 'formulation'],
        note: 'Use for formulation, diagnosis framing, and response-to-treatment wording.',
      },
      {
        id: 'luminello-plan',
        label: 'Plan',
        aliases: ['plan', 'medications', 'follow-up', 'labs', 'referrals'],
        note: 'Use for medications, monitoring, follow-up, labs, referrals, and next steps.',
      },
    ],
  },
  Welligent: {
    label: 'Welligent',
    behavior: 'strict-template-safe',
    summaryLabel: 'Welligent-ready',
    pasteExpectation: 'Favor structured behavioral-health paragraphs that fit service-note and agency documentation templates.',
    fieldGuideSummary: 'Suggested paste targets for behavioral-health service notes; direct writeback remains future connector work.',
    preserveHeadings: true,
    enforceAsciiSafe: true,
    preferParagraphOnly: true,
    normalizeSpacing: true,
  ...
  NextGen: {
    label: 'NextGen',
    behavior: 'section-paste',
    summaryLabel: 'NextGen-ready',
    pasteExpectation: 'Use section-aware outpatient note text that can be copied into encounter documentation fields.',
    fieldGuideSummary: 'Suggested paste targets for outpatient medical, psychiatry, and behavioral-health note templates.',
    preserveHeadings: true,
    enforceAsciiSafe: false,
    preferParagraphOnly: true,
    normalizeSpacing: true,
  ...
  'Practice Fusion': {
    ...
    behavior: 'section-paste',
    summaryLabel: 'Practice Fusion-ready',
    pasteExpectation: 'Use compact outpatient encounter sections for manual copy/paste into visit documentation.',
    fieldGuideSummary: 'Suggested paste targets for outpatient psychiatry and primary-care psych workflows.',
    preserveHeadings: true,
    enforceAsciiSafe: false,
    preferParagraphOnly: true,
    normalizeSpacing: true,
  ...
  'MEDITECH Expanse': {
    ...
    behavior: 'section-paste',
    summaryLabel: 'MEDITECH Expanse-ready',
    pasteExpectation: 'Use conservative section text for hospital or clinic note fields where manual paste remains the safe near-term path.',
    fieldGuideSummary: 'Suggested paste targets for common MEDITECH Expanse note sections; direct writeback remains future connector work.',
    preserveHeadings: true,
    enforceAsciiSafe: false,
    preferParagraphOnly: false,
    normalizeSpacing: true,
  ...
  AdvancedMD: {
    ...
    fieldGuideSummary: 'Suggested paste targets for appointment-linked note sections and manual chart entry; direct AdvancedMD writeback remains future connector work.',
    preserveHeadings: true,
    enforceAsciiSafe: false,
    preferParagraphOnly: true,
    normalizeSpacing: true,
  ...
  DrChrono: {
    ...
    fieldGuideSummary: 'Suggested paste targets for outpatient medical and psychiatry note sections; direct DrChrono writeback remains future connector work.',
    preserveHeadings: true,
    enforceAsciiSafe: false,
    preferParagraphOnly: true,
    normalizeSpacing: true,
